...
lyr_OpenStreetMap_0.setVisible(true);lyr_communeSN_1.setVisible(true);lyr_secteursNeste_2.setVisible(true);lyr_Dpartements_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_communeSN_1,lyr_secteursNeste_2,lyr_Dpartements_3];
...
lyr_Dpartements_3.set('fieldImages', {'NOM_DEPT': 'TextEdit', 'INSEE_DEPT': 'TextEdit', 'SUPERFICIE': 'TextEdit', 'POPULATION': 'TextEdit', 'NOM_REGION': 'TextEdit', 'INSEE_REG': 'TextEdit', });
...
lyr_secteursNeste_2.set('fieldLabels', {'secteurs': 'no label', '1j/sem': 'no label', '2j/sem': 'no label', '3,5j/sem': 'no label', });
